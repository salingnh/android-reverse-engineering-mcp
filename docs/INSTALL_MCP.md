...
Current published release is **0.4.0**. Release metadata is promoted to `master` only after exact-head CI and immutable capability-image verification complete.
